...
### 运维自动化发展历程及技术应用
![image](images/ansible/6F5B086A36464AF29DC98BEED570F3C1.png)
...
### 运维自动化发展历程及技术应用
​	![image](images/ansible/E8D4C3F76C214F7EA908F5AD59218D32.png)
...
```
![image](images/ansible/D651B3E163FC4316970259344AA207AB.png)
...
### Ansible架构
![image](images/ansible/391475DC87174BDDB90DA6D102152C03.png)
```
ansible的作用以及工作结构
1、ansible简介：
...
```
### Ansible工作原理
![image](images/ansible/AA46E01927FE4081962455C8FCC8FD00.png)
...
Command：在远程主机执行命令，默认模块，可忽略-m选项		-m 指定模块，不加默认为command
...
```
### playbook图解
![image](images/ansible/FD38F2B4BE0B49578DCC4CB58E218543.png)
```
...
### 三种常见的数据交换格式
![image](images/ansible/8B5EADE22C804A65A1D9027206BD15F4.png)
...
- hosts: srv120
  ...
  tasks:
    - name:
      ...
      when: ansible_distribution_major_version == "7"
```
![image](images/ansible/A6150393F3CF41DEAFD7A7002C2F952E.png)
### 迭代：with_items
```
...
### Ansible Roles目录编排
![image](images/ansible/63539E099AD1483D87CD28CBD473463B.png)
...
### Roles案例
Roles目录编排    
![image](images/ansible/31BB6620C07C4E8DAEC14CB20CF8C573.png)

Playbook中调用     
![image](images/ansible/B2206BA3F50D46ACBCC941F778A2C845.png)
