...
echo "172.31.177.170  kube-master" >> /etc/hosts



#主节点初始化
kubeadm init \
--apiserver-advertise-address=172.31.177.170 \
...
and service account keys on each node and then running the following as root:
  ...
  kubeadm join kube-master:6443 --token 7mco5c.yhw8v1cm1ca2dgcs \
    --discovery-token-ca-cert-hash sha256:1c78d00402b65e936ea502cd55c9249f4ee2a9d555729fbdeb364795e41b8c10 \
    --control-plane 
